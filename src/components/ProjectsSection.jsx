...
export const ProjectsSection = () => {
  return <section id="projects" className="py-24 px-4 relative">
    <div className="container mx-auto max-w-5xl">
        <h2 className="text-3xl md:text-4xl font-bold mb-4text-center"> {" "} Featured <span className="text-primary"> Projects </span></h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {projects.map((project, key) => (
                <div key={key} className="group bg-card rounded-lg overflow-hidden shadow-xs card-hover">
                    ...
                    <h3 className="text-xl font-semibold mb1">{project.title}</h3>
        ...
        <div className="text-center mt-12">
            <a href="https://github.com/Drecor1798" target="_blank" className="cosmic-button w-fit flex items-center mx-auto gap-2">
